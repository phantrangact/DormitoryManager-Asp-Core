...
namespace DormitoryManager.Areas.Admin.Components
{
    [Area("Admin")]
    [Authorize]
    public class TransissionViewComponent : ViewComponent
    {
        private readonly IStudentService _studentService;
        private readonly IRoomService _roomService;
        private readonly IFloorService _floorService;
        public TransissionViewComponent(IStudentService studentService, IFloorService floorService, IRoomService roomService)
        {
